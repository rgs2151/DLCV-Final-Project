...
from cv2 import VideoCapture, waitKey, imshow, cvtColor, flip, COLOR_BGR2RGB, COLOR_RGB2BGR, putText, FONT_HERSHEY_SIMPLEX, resize, rectangle, line, CAP_PROP_FRAME_COUNT
...
loc = "phone/video/what_1.avi"

cap = VideoCapture(loc)
...
# model = 'Z:/jupyternotebook/ASL-main/ASL-main/Model_generator_4class/ADB_9_95'
model = "test/model36"
...
text1 = ''
results_forever=""
frame_length = int(cap.get(CAP_PROP_FRAME_COUNT))
